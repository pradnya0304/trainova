...
const mealSuggestions = {
  muscle_gain: {
    ...
    vegetarian: {
      ...
      lunch: [
        { food: 'Paneer', amount: '150g', protein: 27, carbs: 4, fat: 20, calories: 265 },
        { food: 'Brown Rice', amount: '150g', protein: 4, carbs: 34, fat: 2, calories: 167 },
        { food: 'Dal', amount: '150g', protein: 14, carbs: 30, fat: 1, calories: 174 },
        { food: 'Mixed Vegetables', amount: '100g', protein: 2, carbs: 8, fat: 0, calories: 40 }
      ],
      dinner: [
        { food: 'Soya Chunks', amount: '100g', protein: 52, carbs: 33, fat: 0, calories: 345 },
        { food: 'Roti', amount: '2 rotis', protein: 8, carbs: 40, fat: 6, calories: 248 },
        { food: 'Curd', amount: '150g', protein: 7, carbs: 6, fat: 4, calories: 88 },
        { food: 'Spinach', amount: '100g', protein: 3, carbs: 4, fat: 0, calories: 23 }
      ],
      snack: [
        { food: 'Greek Yogurt', amount: '200g', protein: 20, carbs: 8, fat: 0, calories: 118 },
    ...
    nonveg: {
      breakfast: [
        { food: 'Boiled Eggs', amount: '4 eggs', protein: 24, carbs: 1, fat: 20, calories: 280 },
        { food: 'Oats', amount: '80g', protein: 14, carbs: 53, fat: 6, calories: 311 },
        { food: 'Banana', amount: '1 medium', protein: 1, carbs: 23, fat: 0, calories: 89 },
        { food: 'Whole Milk', amount: '200ml', protein: 6, carbs: 10, fat: 6, calories: 122 }
      ],
      lunch: [
        { food: 'Chicken Breast', amount: '250g', protein: 78, carbs: 0, fat: 10, calories: 413 },
        { food: 'White Rice', amount: '200g', protein: 5, carbs: 56, fat: 0, calories: 260 },
        { food: 'Broccoli', amount: '100g', protein: 3, carbs: 7, fat: 0, calories: 34 }
      ],
      dinner: [
        { food: 'Salmon', amount: '200g', protein: 40, carbs: 0, fat: 26, calories: 416 },
        { food: 'Sweet Potato', amount: '200g', protein: 4, carbs: 40, fat: 0, calories: 172 },
        { food: 'Spinach', amount: '100g', protein: 3, carbs: 4, fat: 0, calories: 23 }
      ],
      snack: [
        { food: 'Canned Tuna', amount: '100g', protein: 26, carbs: 0, fat: 1, calories: 116 },
  ...
  fat_loss: {
    ...
    vegetarian: {
      ...
      lunch: [
        { food: 'Grilled Paneer', amount: '100g', protein: 18, carbs: 3, fat: 14, calories: 177 },
        { food: 'Mixed Salad', amount: '200g', protein: 4, carbs: 8, fat: 0, calories: 40 },
        { food: 'Brown Rice', amount: '100g', protein: 3, carbs: 23, fat: 1, calories: 111 },
        { food: 'Dal', amount: '100g', protein: 9, carbs: 20, fat: 0, calories: 116 }
      ],
      dinner: [
    ...
    nonveg: {
      breakfast: [
        { food: 'Boiled Egg Whites', amount: '5 whites', protein: 18, carbs: 1, fat: 0, calories: 85 },
        { food: 'Oatmeal', amount: '60g', protein: 10, carbs: 40, fat: 4, calories: 233 },
        { food: 'Berries', amount: '100g', protein: 1, carbs: 12, fat: 0, calories: 50 },
        { food: 'Black Coffee', amount: '250ml', protein: 0, carbs: 0, fat: 0, calories: 5 }
      ],
      lunch: [
        { food: 'Grilled Chicken', amount: '200g', protein: 62, carbs: 0, fat: 8, calories: 330 },
        { food: 'Mixed Salad', amount: '200g', protein: 4, carbs: 8, fat: 0, calories: 40 },
        { food: 'Brown Rice', amount: '80g', protein: 2, carbs: 18, fat: 1, calories: 89 }
      ],
      dinner: [
        { food: 'Grilled Fish', amount: '200g', protein: 44, carbs: 0, fat: 8, calories: 240 },
        { food: 'Steamed Vegetables', amount: '200g', protein: 4, carbs: 14, fat: 0, calories: 72 },
        { food: 'Cucumber Salad', amount: '100g', protein: 1, carbs: 4, fat: 0, calories: 15 }
      ],
      snack: [
        { food: 'Canned Tuna', amount: '100g', protein: 26, carbs: 0, fat: 1, calories: 116 },
        { food: 'Apple', amount: '1 medium', protein: 0, carbs: 25, fat: 0, calories: 95 },
  ...
  recomp: {
    ...
    vegetarian: {
      breakfast: [
        ...
        { food: 'Oats', amount: '60g', protein: 10, carbs: 40, fat: 5, calories: 233 },
        { food: 'Banana', amount: '1 medium', protein: 1, carbs: 23, fat: 0, calories: 89 },
        { food: 'Milk', amount: '200ml', protein: 6, carbs: 10, fat: 6, calories: 122 }
      ],
      lunch: [
        { food: 'Paneer', amount: '150g', protein: 27, carbs: 4, fat: 20, calories: 265 },
        { food: 'Brown Rice', amount: '120g', protein: 4, carbs: 28, fat: 1, calories: 133 },
        { food: 'Dal', amount: '100g', protein: 9, carbs: 20, fat: 0, calories: 116 },
        { food: 'Salad', amount: '100g', protein: 2, carbs: 4, fat: 0, calories: 20 }
      ],
      dinner: [
        { food: 'Moong Dal', amount: '150g', protein: 11, carbs: 29, fat: 0, calories: 158 },
        { food: 'Roti', amount: '2 rotis', protein: 8, carbs: 40, fat: 6, calories: 248 },
        { food: 'Curd', amount: '150g', protein: 7, carbs: 6, fat: 4, calories: 88 }
      ],
      snack: [
    ...
    nonveg: {
      breakfast: [
        { food: 'Boiled Eggs', amount: '3 eggs', protein: 18, carbs: 1, fat: 15, calories: 210 },
        { food: 'Oats', amount: '80g', protein: 14, carbs: 53, fat: 6, calories: 311 },
        { food: 'Banana', amount: '1 medium', protein: 1, carbs: 23, fat: 0, calories: 89 }
      ],
      lunch: [
      ...
      dinner: [
        { food: 'Tuna', amount: '150g', protein: 39, carbs: 0, fat: 2, calories: 174 },
        { food: 'Sweet Potato', amount: '150g', protein: 3, carbs: 30, fat: 0, calories: 129 },
        { food: 'Spinach', amount: '100g', protein: 3, carbs: 4, fat: 0, calories: 23 }
      ],
      snack: [
        { food: 'Boiled Eggs', amount: '2 eggs', protein: 12, carbs: 1, fat: 10, calories: 140 },
        { food: 'Apple', amount: '1 medium', protein: 0, carbs: 25, fat: 0, calories: 95 }
      ]
    }
  },
  endurance: {
    ...
    vegetarian: {
      ...
      lunch: [
        { food: 'Pasta', amount: '200g', protein: 10, carbs: 50, fat: 2, calories: 262 },
        { food: 'Paneer', amount: '100g', protein: 18, carbs: 3, fat: 14, calories: 177 },
        { food: 'Tomato Sauce', amount: '100g', protein: 2, carbs: 8, fat: 1, calories: 50 }
      ],
      dinner: [
        { food: 'Brown Rice', amount: '200g', protein: 6, carbs: 46, fat: 2, calories: 222 },
        { food: 'Dal', amount: '200g', protein: 18, carbs: 40, fat: 1, calories: 232 },
        { food: 'Sweet Potato', amount: '150g', protein: 3, carbs: 30, fat: 0, calories: 129 }
      ],
      snack: [
        { food: 'Dates', amount: '50g', protein: 1, carbs: 38, fat: 0, calories: 141 },
    ...
    nonveg: {
      ...
      dinner: [
        { food: 'Brown Rice', amount: '200g', protein: 6, carbs: 46, fat: 2, calories: 222 },
        { food: 'Grilled Fish', amount: '150g', protein: 33, carbs: 0, fat: 8, calories: 204 },
        { food: 'Sweet Potato', amount: '150g', protein: 3, carbs: 30, fat: 0, calories: 129 }
      ],
      snack: [
        { food: 'Dates', amount: '50g', protein: 1, carbs: 38, fat: 0, calories: 141 },
  ...
  mobility: {
    both: {
      ...
      dinner: [
        { food: 'Grilled Fish', amount: '200g', protein: 44, carbs: 0, fat: 10, calories: 240 },
        { food: 'Brown Rice', amount: '120g', protein: 4, carbs: 28, fat: 1, calories: 133 },
    ...
    nonveg: {
      ...
      snack: [
        { food: 'Walnuts', amount: '30g', protein: 5, carbs: 4, fat: 20, calories: 196 },
        { food: 'Blueberries', amount: '100g', protein: 1, carbs: 14, fat: 0, calories: 57 },
        { food: 'Tuna', amount: '100g', protein: 26, carbs: 0, fat: 1, calories: 116 }
      ]
    }
  }
}
...
const dietOptions = [
  { key: 'both', label: 'Veg + Non Veg', desc: 'I eat everything' },
  { key: 'vegetarian', label: 'Vegetarian', desc: 'No meat or fish' },
  { key: 'nonveg', label: 'Non Vegetarian', desc: 'Meat and fish only' }
]
...
const PlatePlanner = () => {
  ...
  const goalMeals = mealSuggestions[goal] || mealSuggestions['muscle_gain']
  const meals = goalMeals[dietType] || goalMeals['both']
        ...
        <main className="plate-main">
          ...
          <div className="animate-fade-in">
            ...
            <p className="section-subtitle">
              Meal suggestions built around your goal and diet preference. See exactly what your plate should look like for each meal.
            </p>
          </div>
          ...
          {targets && (
            <div className="card plate-goal-bar animate-fade-in">
              ...
              <div className="plate-goal-divider"></div>
              <div className="plate-goal-item">
                <p className="plate-goal-label">Protein</p>
                <p className="plate-goal-value">{targets.protein}g</p>
              </div>
              <div className="plate-goal-divider"></div>
              <div className="plate-goal-item">
                <p className="plate-goal-label">Carbs</p>
                <p className="plate-goal-value">{targets.carbs}g</p>
              </div>
              <div className="plate-goal-divider"></div>
              <div className="plate-goal-item">
                <p className="plate-goal-label">Fat</p>
                <p className="plate-goal-value">{targets.fat}g</p>
              </div>
            </div>
          )}

          <div className="card diet-selector animate-fade-in">
            <h3 className="card-section-title">What do you eat?</h3>
            <div className="diet-options">
              {dietOptions.map(opt => (
                <button
                  key={opt.key}
                  className={`diet-option-btn ${dietType === opt.key ? 'active' : ''}`}
                  onClick={() => setDietType(opt.key)}
                >
                  <p className="diet-option-label">{opt.label}</p>
                  <p className="diet-option-desc">{opt.desc}</p>
                </button>
              ))}
            </div>
          </div>
                  ...
                  <div className="plate-targets">
                    {[
                      ...
                      <div key={i} className="plate-target-row">
                        ...
                        <span className="plate-target-pct">{Math.round((t.meal / t.target) * 100)}%</span>
                      </div>
                    ))}
                  </div>
                  <p className="plate-target-note">
                    This meal covers {Math.round((totalCalories / targets.calories) * 100)}% of your daily calorie target.
                  </p>
                </div>
              )}
            </div>
                    ...
                    <div key={i} className="plate-food-item">
                      <div className="plate-food-left">
                        <div
                          ...
                          style={{ backgroundColor: mealBg[activeMeal], color: mealColors[activeMeal] }}
                        >
                          {i + 1}
                        </div>
                        <div>
              ...
              <div className="card plate-tips-card">
                ...
                <ul className="plate-tips-list">
                  {goal === 'muscle_gain' && activeMeal === 'breakfast' && <>
                    ...
                    {dietType !== 'vegetarian' && <li>Whole eggs include yolk — that is where the anabolic hormones come from.</li>}
                    {dietType === 'vegetarian' && <li>Paneer and milk together give a complete amino acid profile for muscle building.</li>}
                  </>}
                  {goal === 'muscle_gain' && activeMeal === 'lunch' && <>
                    ...
                    {dietType === 'vegetarian' && <li>Combining dal and rice gives a complete protein source comparable to meat.</li>}
                    {dietType !== 'vegetarian' && <li>Chicken breast is the most efficient protein source gram for gram.</li>}
                    <li>White rice digests faster than brown rice which is useful for pre-workout energy.</li>
                  </>}
                  {goal === 'muscle_gain' && activeMeal === 'dinner' && <>
                    {dietType !== 'vegetarian' && <li>Salmon at night is ideal — the fats slow protein digestion for overnight muscle repair.</li>}
                    {dietType === 'vegetarian' && <li>Soya chunks have the highest protein content of any vegetarian food.</li>}
                  ...
                  {goal === 'muscle_gain' && activeMeal === 'snack' && <>
                    ...
                    {dietType === 'nonveg' && <li>Canned tuna is one of the cheapest and highest protein snacks available.</li>}
                  </>}
                  {goal === 'fat_loss' && <>
                    <li>Stay in a 300 to 500 calorie deficit daily — consistency beats perfection.</li>
                    {dietType === 'vegetarian' && <li>Tofu and paneer keep you full longer due to their protein and fat content.</li>}
                    {dietType !== 'vegetarian' && <li>Lean meats like chicken and fish keep protein high while calories stay low.</li>}
                    <li>Fill half the plate with vegetables — high volume, low calorie.</li>
                  </>}
                  {goal === 'recomp' && <>
                    <li>Eat at maintenance calories — let the training do the work of changing body composition.</li>
                    <li>High protein intake is the most important factor for recomposition.</li>
                    {dietType === 'vegetarian' && <li>Combine multiple plant proteins throughout the day to cover all amino acids.</li>}
                  </>}
                  {goal === 'endurance' && <>
                    <li>Carbohydrates are your primary fuel — do not restrict them on training days.</li>
                    <li>Eat 2 to 3 hours before long sessions so digestion is complete.</li>
                    <li>Dates and bananas are excellent pre-session energy sources.</li>
                  </>}
                  {goal === 'mobility' && <>
                    <li>Anti-inflammatory foods directly improve joint flexibility and reduce soreness.</li>
                    {dietType !== 'vegetarian' && <li>Salmon and fish oils reduce joint inflammation significantly.</li>}
                    {dietType === 'vegetarian' && <li>Walnuts are the best plant-based source of anti-inflammatory omega 3 fats.</li>}
